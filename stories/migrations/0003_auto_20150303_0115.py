...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('stories', '0002_auto_20150227_2315'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='story',
            name='location',
            field=models.ForeignKey(to='stories.Location', null=True),
            preserve_default=True,
        ),
    ]
